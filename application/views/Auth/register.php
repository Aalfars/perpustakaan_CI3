            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">perpus</span>
                </a>
              </div>
              <!-- /Logo -->
              ...
              <form id="formAuthentication" class="mb-3" action="<?=base_url('auth/process_register')?>" method="POST">
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <textarea required name="alamat" class="form-control" id=""></textarea>
                </div>
