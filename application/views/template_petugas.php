		...
		<div class="layout-container">
			...
			<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
				<div class="app-brand demo">
					<a href="<?=base_url('Petugas')?>" class="app-brand-link">
				...
				<ul class="menu-inner py-1">
					...
					<li class="menu-item <?php if($url == ''){echo 'active';}?>">
					...
					<li class="menu-item <?php if($url =='kategori'){echo 'active';}?>">
						<a href="<?=base_url('Petugas/kategori')?>" class="menu-link">
							<i class="menu-icon tf-icons bx bx-package"></i>
							<div data-i18n="Analytics">Kategori</div>
						</a>
					</li>
					<li class="menu-item <?php if($url == 'buku'){echo 'active';}?>">
						<a href="<?=base_url('Petugas/buku')?>" class="menu-link">
							<i class="menu-icon tf-icons bx bx-book"></i>
							<div data-i18n="Analytics">Buku</div>
						</a>
					</li>
					<li class="menu-item <?php if($url == 'approval'){echo 'active';}?>">
						<a href="<?=base_url('Petugas/approval')?>" class="menu-link">
				...
				<a href="<?=base_url('Auth/logout')?>" class="btn btn-danger mx-3 mb-2">Log Out</a>
					...
					<footer class="content-footer footer bg-footer-theme">
						<div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
							<div class="mb-2 mb-md-0">
								...
								, made with ❤️ by
								<a href="https://instagram.com/@aalfars" target="_blank" class="footer-link fw-bolder">Arupaa</a>
							</div>
