	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?= base_url('Petugas/insert_kategori') ?>" method="post">
					<div class="row g-2">
						<div class="col mb-0">
			...
			<tbody class="table-border-bottom-0">
				...
				foreach ($kategori as $a) { ?>
					<tr>
						<td><?= ++$no ?></td>
						<td><?= $a->kategori ?></td>
						<td><a href="" data-bs-toggle="modal" data-bs-target="#edit<?= $a->kategori_id ?>"><i class="bx bx-edit-alt me-1"></i></a> <a onclick="return confirm('Apakah Anda Yakin ingin menghapus kategori ini???')" href="<?= base_url('Petugas/delete_kategori/' . $a->kategori_id) ?>"><i class="bx bx-trash-alt me-1"></i></a></td>
					</tr>
					<div class="modal fade" id="edit<?=$a->kategori_id?>" tabindex="-1" aria-hidden="true">
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								...
								<div class="modal-body">
									<form action="<?= base_url('Petugas/update_kategori') ?>" method="post">
										<div class="row g-2">
											<div class="col mb-0">
